...
INSERT INTO students (id, student_cod, course,full_name, email, team_id) VALUES
                                                                             (1, 20230001, '101','María González Pérez', 'maria.gonzalez@universidad.edu', 1),
                                                                             (2, 20230002, '101','Carlos Rodríguez Sánchez', 'carlos.rodriguez@universidad.edu', 1),
                                                                             (3, 20230003, '101','Ana López Martínez', 'ana.lopez@universidad.edu', 1),
                                                                             (4, 20230004, '101','Pedro Sánchez Fernández', 'pedro.sanchez@universidad.edu', 1),
                                                                             (5, 20230005, '101','Laura Martínez Gómez', 'laura.martinez@universidad.edu', 2),
                                                                             (6, 20230006, '101','Jorge Fernández Ruiz', 'jorge.fernandez@universidad.edu', 2),
                                                                             (7, 20230007, '101','Sofía Pérez Díaz', 'sofia.perez@universidad.edu', 2),
                                                                             (8, 20230008, '101','David Gómez Hernández', 'david.gomez@universidad.edu', 3),
                                                                             (9, 20230009, '101','Elena Ruiz Moreno', 'elena.ruiz@universidad.edu', 3),
                                                                             (10, 20230010, '101','Miguel Hernández Ortega', 'miguel.hernandez@universidad.edu', 4);

INSERT INTO students (id, student_cod, course ,full_name, email, team_id) VALUES
                                                                              (11, 20230011, '101','Luis Castro Méndez', 'luis.castro@universidad.edu', NULL),
                                                                              (12, 20230012, '101','Daniela Vargas Soto', 'daniela.vargas@universidad.edu', NULL),
                                                                              (13, 20230013, '101','Roberto Jiménez Rojas', 'roberto.jimenez@universidad.edu', NULL);

package co.unicauca.chpp.platform.workspace.domain.service;

import java.util.List;

import org.springframework.stereotype.Service;

import co.unicauca.chpp.platform.workspace.application.input.IWorkSpaceService;
import co.unicauca.chpp.platform.workspace.domain.model.WorkSpace;
import co.unicauca.chpp.platform.workspace.domain.model.exception.WorkSpaceException;
import co.unicauca.chpp.platform.workspace.infraestructure.output.persistence.WorkSpacePersistenceAdapter;
